...
export default function ProfilePage() {
  ...
  return (
    <main className="min-h-screen w-full bg-purple-300 p-4 sm:p-6 relative overflow-hidden">
      <button
        onClick={() => router.back()}
      ...
      <div className="w-full max-w-xs sm:max-w-md md:max-w-lg mx-auto bg-white/60 backdrop-blur-xl shadow-lg rounded-3xl p-6 sm:p-8 flex flex-col items-center relative border border-purple-200">
        ...
        <div className="relative group w-[120px] h-[120px] sm:w-[150px] sm:h-[150px] z-10 mb-4 rounded-full">
          <Image
